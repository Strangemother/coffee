...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'reserved_product_categories')
        ...
        # Changing field 'NamedObject.icon_name'
        db.alter_column(u'reserved_namedobject', 'icon_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'reserved_product_categories'))


        # User chose to not deal with backwards NULL issues for 'NamedObject.icon_name'
        raise RuntimeError("Cannot reverse this migration. 'NamedObject.icon_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'NamedObject.icon_name'
        db.alter_column(u'reserved_namedobject', 'icon_name', self.gf('django.db.models.fields.CharField')(max_length=200))
