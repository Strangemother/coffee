...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'reserved_openingtimes')

        # Adding model 'OpeningTime'
        db.create_table(u'reserved_openingtime', (
            (u'timing_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['reserved.Timing'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'reserved', ['OpeningTime'])


    def backwards(self, orm):
        # Adding model 'OpeningTimes'
        db.create_table(u'reserved_openingtimes', (
            (u'timing_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['reserved.Timing'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'reserved', ['OpeningTimes'])

        # Deleting model 'OpeningTime'
        db.delete_table(u'reserved_openingtime')
    ...
    models = {
        ...
        u'reserved.openingtime': {
            'Meta': {'object_name': 'OpeningTime', '_ormbases': [u'reserved.Timing']},
            u'timing_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['reserved.Timing']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'reserved.product': {
